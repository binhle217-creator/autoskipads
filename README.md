...
- **Phím tắt Bật/Tắt Anti-Pause Shield (YouTube):** Vì tính năng khiên bảo vệ (Shield) sẽ vô hiệu hoá mọi lệnh pause (kể cả thao tác của người dùng), nếu bạn muốn pause thủ công video YouTube, chỉ cần **nhấn đúp phím `Shift`** trên bàn phím. Một thông báo nhỏ màu đỏ sẽ hiện ra xác nhận Shield đã tắt. Nhấn đúp thêm lần nữa để bật lại.
